...
import { FavoritesDialogComponent } from '../../../../../../main/webapp/app/entities/favorites/favorites-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Favorites Management Dialog Component', () => {
        let comp: FavoritesDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(FavoritesDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'favoritesListModification', content: 'OK'});
